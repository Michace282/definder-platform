<template>
  ...
  >
    ...
    <div class="round-info__raised">
      <div class="round-info__raised-of">In favor Votes</div>
      <div class="round-info__raised-goal">
        {{ projectData.countPointsUp }}
      </div>
    </div>
...
export default {
  ...
  computed: {
    ...
    progress() {
      ...
      // }
      return (
        (this.projectData.countPointsUp * 100) / this.projectData.countPoints
      )
      // return this.totalDays - this.daysGone > 0
