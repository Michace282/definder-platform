<template>
  ...
  >
    ...
    <div class="round-info__raised">
      <div class="round-info__raised-of">Votes Against</div>
      <div class="round-info__raised-goal">
        {{ projectData.countPointsDown }}
      </div>
    </div>
    ...
    <div class="round-info__investors">
      <div class="round-info__caption">Votes</div>
      <div class="round-info__caption-data">
        {{ projectData.countVotesDown }}
      </div>
    </div>

    <div class="round-info__progress">
      <BaseProgress :value="progress" class="round-info__progress-bar__down" />
...
export default {
  ...
  computed: {
    ...
    progress() {
      ...
      // }
      return (
        (this.projectData.countPointsDown * 100) / this.projectData.countPoints
      )
      // return this.totalDays - this.daysGone > 0
